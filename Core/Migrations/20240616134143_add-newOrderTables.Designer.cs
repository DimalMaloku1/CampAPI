...
namespace Core.Migrations
{
    ...
    [Migration("20240616134143_add-newOrderTables")]
    partial class addnewOrderTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entites.OrderEntities.Order", b =>
                {
                    ...
                    b.Property<int>("PurchasedCampId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entites.OrderEntities.Order", b =>
                {
                    b.HasOne("Core.Entites.Camp", "PurchasedCamp")
                        .WithMany()
                        .HasForeignKey("PurchasedCampId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
